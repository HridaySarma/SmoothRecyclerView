...
public class SmoothRecyclerLayoutManager extends RecyclerView.LayoutManager {
    ...
    public SmoothRecyclerLayoutManager(boolean isFlat,boolean isGreyItem,boolean isAlphaItem,float cstInterval) {
        mIsFlatFlow = isFlat;
...
//            cm.setSaturation(0.9f);
    ...
    public static class Builder {
        ...
        public SmoothRecyclerLayoutManager build() {
            return new SmoothRecyclerLayoutManager(isFlat, isGreyItem,
